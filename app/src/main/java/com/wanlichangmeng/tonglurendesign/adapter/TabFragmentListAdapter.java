...
public class TabFragmentListAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public TabFragmentListAdapter(Context context, List<Updating> data) {
